...
//		objectives[1] = (WSCInitializer.w5 * t) + (WSCInitializer.w6 * c);
		...
		objectives[0] = WSCInitializer.w1 * mt;
		objectives[1] = WSCInitializer.w2 * dst;
		objectives[2] = WSCInitializer.w3 * a;
		objectives[3] = WSCInitializer.w4 * r;
		objectives[4] = WSCInitializer.w5 * t;
		objectives[5] = WSCInitializer.w6 * c ;
