...
public class Spea2CrossoverPipelineForNonFront extends BreedingPipeline {
	...
	public int produce(int min, int max, int start, int subpopulation,
		...
		List<Individual> frontInds = GenerationIndsMap.frontMap.get(state.generation);
		int archiveIndex = WSCInitializer.random.nextInt(frontInds.size()-1) ;
		wsc.ecj.nsga2.SequenceVectorIndividual t1 = ((wsc.ecj.nsga2.SequenceVectorIndividual)frontInds.get(archiveIndex));
		wsc.ecj.nsga2.SequenceVectorIndividual t2 = ((wsc.ecj.nsga2.SequenceVectorIndividual)frontInds.get(archiveIndex+1));
		// Perform crossover
